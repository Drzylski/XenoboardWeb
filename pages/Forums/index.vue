<template>
  ...
  <b-container fluid class="topics-container topics-opacity mt-4 pt-1 stat-header" >
    ...
    <BRow class="section-header topics-opacity ps-3 pb-1 pt-1 pe-3"  >    
      ...
      <BCol class="A-Button">
          <NuxtLink class="alien-link" :to="{ path: '/TopSecret'}">
          <BButton v-if="isAuthorized" class="alien-button mt-1"   >
...
.stat-header:hover > .section-header > .A-Button > .alien-link > .alien-button {
  opacity: 1 !important;
