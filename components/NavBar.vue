        ...
        <BRow class="justify-content-end nav-buttons-group">
          <BCol class="col-auto">
            ...
            <NuxtLink :to="{ path: '/Search'}">
              <svg id="popover-search" class="icon ps-0 ms-md-4 ms-2" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <title>search</title> <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M14.9536 14.9458L21 21M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10Z" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
            </NuxtLink>
            <span v-if="authorized" @click="showLoginModal" class="ms-md-4 ms-2 nav-button">Login</span>
