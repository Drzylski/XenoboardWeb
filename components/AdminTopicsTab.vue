<template>
  <div fluid class=" pt-3 pb-5 admin-tab-background" >
    ...
    <BRow class="ps-3 pe-3 pb-0">
      <BCol class="col-12" >
        <div style="text-align: center;">
          <h2 ><BBadge>Admin Topics</BBadge></h2>
        </div>
      </BCol>
    </BRow>
  </b-container>
...
const topics: TableItem<SortTopic>[] = [
  {id: '40', title: 'My first Post', date: new Date('4/14/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '21', title: 'This game sucks', date: new Date('7/23/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '89', title: 'A deep introspection on video games', date: new Date('9/04/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '38', title: 'Hosting smash bros event', date: new Date('12/24/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '40', title: 'My first Post', date: new Date('4/14/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '21', title: 'This game sucks', date: new Date('7/23/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '89', title: 'A deep introspection on video games', date: new Date('9/04/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
  {id: '38', title: 'Hosting smash bros event', date: new Date('12/24/2026'), author: 'SeiferAlmasy', approved: true, reported: false, deleted: false},
