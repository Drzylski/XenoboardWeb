<template>
  <b-container fluid class="admin-footer-body p-3 mt-1" style="z-index:1;position: relative;  ">
    ...
    <BRow>
      <BCol class="col-12 copyright-text">
          <span class="copyright-text">Copyright &#169 {{ year }} Damian Zylski</span>
      </BCol>
    </BRow>
  </b-container>
</template>
